...
rebuild_firmware() {
    ...
    # Modem Tools
    PACKAGES+=" modeminfo atinout modemband luci-app-modemband luci-app-mmconfig sms-tool luci-app-sms-tool-js luci-app-3ginfo-lite picocom minicom"
    ...
    PACKAGES+=" luci-app-diskman smartmontools ntfs-3g"
    ...
    misc+=" luci-app-temp-status luci-theme-alpha luci-theme-argon luci-app-cpufreq luci-app-droidnet luci-app-eqosplus luci--app-modeminfo luci-app-rakitanmanager luci-app-tinyfm"
    ...
    PACKAGES+=" $misc zram-swap adb parted losetup luci luci-ssl block-mount luci-app-poweroff luci-app-ramfree htop bash curl wget-ssl unzip jq luci-app-ttyd"
