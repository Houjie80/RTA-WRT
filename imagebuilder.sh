...
custom_packages() {
    ...
    other_packages=(
        ...
        "luci-app-tailscale|https://dl.openwrt.ai/packages-24.10/packages/$ARCH_3/kiddin9"
        "luci-app-diskman|https://dl.openwrt.ai/packages-24.10/packages/$ARCH_3/kiddin9"
        "modeminfo|https://dl.openwrt.ai/packages-24.10/packages/$ARCH_3/kiddin9"
        "atinout|https://dl.openwrt.ai/packages-24.10/packages/$ARCH_3/kiddin9"
        "luci-app-poweroff|https://dl.openwrt.ai/packages-24.10/packages/$ARCH_3/kiddin9"
        "xmm-modem|https://dl.openwrt.ai/packages-24.10/packages/$ARCH_3/kiddin9"
        "luci-app-lite-watchdog|https://dl.openwrt.ai/packages-24.10/packages/$ARCH_3/kiddin9"
